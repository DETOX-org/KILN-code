...
// KILN-Code / DETOX Competitive Programming Platform
// ============================================================
...
export type ContestStatus = 'draft' | 'scheduled' | 'running' | 'ended' | 'archived';
...
export interface SubmissionSubtaskResultDTO {
  subtask_id: string;
  order_index: number;
  title?: string;
  status: JudgeStatus;
...
export interface DiscrepancyDetailsDTO {
  summary: string;
...
export interface SubmissionDTO {
  ...
  is_verified: boolean;
  discrepancy_details?: DiscrepancyDetailsDTO | null;
  verification_notes?: string | null;
  verified_at?: string | null;
  submitted_at: string;
  subtask_results?: SubmissionSubtaskResultDTO[];
}
